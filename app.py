# Write a robust replacement Streamlit app that fixes yfinance/formatting errors.
code = r'''
...
'''
open('/mnt/data/app_fixed.py','w',encoding='utf-8').write(code)
print("Wrote /mnt/data/app_fixed.py")
